...
faceProto = 'src/app/models/opencv_face_detector.pbtxt'
faceModel = 'src/app/models/opencv_face_detector_uint8.pb'

#initialize age and gender protocol buffer and model
ageProto = 'src/app/models/age_deploy.prototxt'
ageModel = 'src/app/models/age_net.caffemodel'
